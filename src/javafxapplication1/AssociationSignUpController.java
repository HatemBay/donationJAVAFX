...
public class AssociationSignUpController implements Initializable {
    ...
    @FXML
    private Button ASSUSubmit;
    @FXML
    private Button ASSUSubmit1;
    ...
    private void assocSignIn(ActionEvent event) throws IOException, SQLException{
        ...
        *
            ...
            Parent tableViewParent = FXMLLoader.load(getClass().getResource("RSE.fxml"));//(interface assoc)
    ...
    @FXML
    private void assocSignInBack(ActionEvent event) throws IOException {
    ...
    @FXML
    private void userSignUpBack(ActionEvent event) throws IOException {
