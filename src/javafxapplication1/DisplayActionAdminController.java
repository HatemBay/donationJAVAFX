 ...
 * @author Tarek
 */
public class DisplayActionAdminController implements Initializable {
     ...
     */
        com.donation.Service.ServiceAction SAC = new ServiceAction(); 
        ...
        for (int i = 0; i < actions.size(); i++) {
            ...
            supprimer.setOnMouseClicked((MouseEvent e) ->{
                   try {              
                       ...
                       AnchorPane redirect;
                       redirect = FXMLLoader.load(getClass().getResource("DisplayActionAdmin.fxml"));
...
//            });
    ...
    private void goAssociation(ActionEvent event)throws IOException {
            ...
            AnchorPane asso;
            asso = FXMLLoader.load(getClass().getResource("DisplayAssociationAdmin.fxml")); 
    ...
    private void toAssociations(ActionEvent event) throws IOException {
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("DisplayAdminAction.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
