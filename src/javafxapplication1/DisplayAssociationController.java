...
public class DisplayAssociationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            Association connected = SA.getById(SA.currentAssociation.getId_Association());

            afficher(associations);
            Image men = new Image("pics/afficher_1.jpg");
    ...
    private void afficher(List<Association> associations) throws SQLException {
        ...
        for (int i = 0; i < associations.size(); i++) {
            ...
            System.out.println("slmslm" + SA.currentAssociation.getId_Association());

            if (actuel.getId_Association() == SA.currentAssociation.getId_Association()) {
                ...
                modifier.setOnMouseClicked((MouseEvent e) -> {
                    ...
                    browse.setOnMouseClicked((MouseEvent ee)->{
                    ...
                    update.setOnMouseClicked((MouseEvent er) -> {
                        ...
                        if (password.getText().equals(actuel.getPassword_Association())) {
                            ...
                            System.out.println("mot de passe incorrect(a remplacer)"); //a remplacer
                        }
                    });
