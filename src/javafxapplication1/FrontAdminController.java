...
public class FrontAdminController implements Initializable {
    ...
    public void Mail(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("MakeOffer.fxml"));
            n[19] = loader.load();
...
//    
    void appeldon(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("Front_Appeldon.fxml"));
            n[14] = loader.load();
...
//    }
    ...
    void creerdon(ActionEvent event) throws IOException {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("Ajout_appeldon.fxml"));
...
//    }
    ...
    public void listeoffre(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("offre.xml"));
