...
public class SendMail {
    public static void sendMail(String receveursList,String object,String corps) {
        ...
        String MonEmail = "khaoula.soury@esprit.tn";
        String password = "193JFT0214";
    ...
    public static void sendMail(String wajihmejriesprittn) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public static void sendMail(String khaoulasourygmailcom, float TotalPrise) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
